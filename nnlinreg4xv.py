...
def extract_data():
    ...
    for line in open(traininputfile):
        row = line.split(" ")
        fvecs.append([float(x) for x in row[1:]])

    for line in open(trainoutputfile):
        row = line.split(" ")
        labels.append([float(x) for x in row[1:]])

    for line in open(testinputfile):
        row = line.split(" ")
        testfvecs.append([float(x) for x in row[1:]])

    for line in open(testoutputfile):
        row = line.split(" ")
        testlabels.append([float(x) for x in row[1:]])

    for line in open(projectfile):
        row = line.split(" ")
